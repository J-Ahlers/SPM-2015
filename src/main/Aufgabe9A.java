...
import list.List;
import math.DistributionDegreeCalculator;
...
public class Aufgabe9A {
	...
	public static void main(String[] args) {
		...
		// calculate degree to which the data is normally distributed
		DistributionDegreeCalculator ddc = new DistributionDegreeCalculator();
		double x = ddc.calculateDegree(testdata, 1);
		
		System.out.println("1-p: " + x);

	}

	/**
	* Puts the given numbers in a new List<Number>
	* 
	*/
